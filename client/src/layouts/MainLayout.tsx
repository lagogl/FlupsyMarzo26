  ...
  const navCategories: NavCategory[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: <Users className="h-5 w-5 mr-2 text-green-600" />, label: translations.menuItems.operators, path: "/operators" },
    ...
    },
    {
      ...
      items: [
        ...
        { icon: <Database className="h-5 w-5 mr-2 text-purple-600" />, label: "Analisi AI Database (BETA)", path: "/analisi-ai-database" },
    ...
    },
    {
      ...
      items: [
        ...
        ...(user?.username?.toLowerCase() === 'gianluigi' ? [{ icon: <TrendingUp className="h-5 w-5 mr-2 text-emerald-600" />, label: "Pianificazione Vendite", path: "/pianificazione-vendite" }] : []),
