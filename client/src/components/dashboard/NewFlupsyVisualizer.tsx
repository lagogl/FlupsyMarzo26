        ...
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              ...
              {/* Mortality indicator - small skull icon in bottom-left corner */}
              {latestOperation?.lastMortalityCount && latestOperation.lastMortalityCount > 0 && (
                <div className="absolute bottom-1 left-1" title={`Mortalità: ${latestOperation.lastMortalityCount} animali`}>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 text-blue-700" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
