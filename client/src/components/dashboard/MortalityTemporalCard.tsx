          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className={`p-2 rounded-lg ${periods.recent.totalDead > 0 ? 'bg-red-100 border border-red-200' : 'bg-gray-100'}`}>
                  ...
                  <div className="text-lg font-bold text-red-600">
                    {periods.recent.totalDead.toLocaleString('it-IT')}
                  </div>
              ...
              <TooltipContent>
                ...
                <p>Media mortalità: {periods.recent.avgMortalityRate.toFixed(1)}%</p>
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className={`p-2 rounded-lg ${periods.medium.totalDead > 0 ? 'bg-yellow-100 border border-yellow-200' : 'bg-gray-100'}`}>
                  ...
                  <div className="text-lg font-bold text-yellow-600">
                    {periods.medium.totalDead.toLocaleString('it-IT')}
                  </div>
              ...
              <TooltipContent>
                ...
                <p>Media mortalità: {periods.medium.avgMortalityRate.toFixed(1)}%</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className={`p-2 rounded-lg ${periods.old.totalDead > 0 ? 'bg-green-100 border border-green-200' : 'bg-gray-100'}`}>
                  ...
                  <div className="text-lg font-bold text-green-600">
                    {periods.old.totalDead.toLocaleString('it-IT')}
                  </div>
              ...
              <TooltipContent>
                ...
                <p>Media mortalità: {periods.old.avgMortalityRate.toFixed(1)}%</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
