...
export async function registerRoutes(app: Express, existingServer?: Server): Promise<Server> {
  ...
  const seneyeModule = await import('./modules/seneye');
  ...
  */
  ...
  app.use('/api/ai-chat', authModule.requireAuth, (await import("./modules/ai-chat/ai-chat.routes.js")).aiChatRoutes); // 💬 Chat AI operatori (protetto da login)
