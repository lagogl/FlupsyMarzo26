...
export const DATABASE_METADATA: TableMetadata[] = [
  ...
  
  {
    ...
    relationships: [
      ...
      { type: 'many-to-one', targetTable: 'basket_groups', foreignKey: 'groupId', description: 'Cestello può appartenere a un gruppo' },
...

  {
    ...
    relationships: [
      ...
      { type: 'one-to-many', targetTable: 'basket_lot_composition', foreignKey: 'lotId', description: 'Lotto può essere misto in cestelli' }
    ],
    keyMetrics: [
...

  {
    ...
    relationships: [
      ...
      { type: 'one-to-many', targetTable: 'sgr_per_taglia', foreignKey: 'sizeId', description: 'Taglia ha SGR specifico' }
    ],
    keyMetrics: [
  ...
  // ========== SCREENING & SELECTION ==========
  {
    ...
    relationships: [
      { type: 'one-to-many', targetTable: 'screening_source_baskets', foreignKey: 'screeningId', description: 'Cestelli origine vagliatura' },
      { type: 'one-to-many', targetTable: 'screening_destination_baskets', foreignKey: 'screeningId', description: 'Cestelli destinazione vagliatura' }
    ],
    keyMetrics: [
...

  {
    ...
    relationships: [
      { type: 'one-to-many', targetTable: 'selection_source_baskets', foreignKey: 'selectionId', description: 'Cestelli origine selezione' },
      { type: 'one-to-many', targetTable: 'selection_destination_baskets', foreignKey: 'selectionId', description: 'Cestelli destinazione selezione' }
    ],
    keyMetrics: [
  ...
  // ========== SALES & DDT ==========
  {
    ...
    relationships: [
      { type: 'one-to-many', targetTable: 'sale_bags', foreignKey: 'saleId', description: 'Sacchi della vendita' },
...

  {
    ...
    relationships: [
      { type: 'many-to-one', targetTable: 'advanced_sales', foreignKey: 'advancedSaleId', description: 'DDT per vendita avanzata' },
  ...
  // ========== OPERATORS & TASKS ==========
  {
    ...
    relationships: [
      { type: 'one-to-many', targetTable: 'selection_task_assignments', foreignKey: 'operatorId', description: 'Attività assegnate' }
    ],
    keyMetrics: [
...

  {
    ...
    relationships: [
      { type: 'one-to-many', targetTable: 'selection_task_assignments', foreignKey: 'taskId', description: 'Assegnazioni task' },
      { type: 'one-to-many', targetTable: 'selection_task_baskets', foreignKey: 'taskId', description: 'Cestelli del task' }
    ],
    keyMetrics: [
  ...
  // ========== EXTERNAL SYNC ==========
  {
    ...
    relationships: [
      { type: 'one-to-many', targetTable: 'ordini_righe', foreignKey: 'ordineId', description: 'Righe ordine' }
    ],
    keyMetrics: [
      'Ordini aperti',
  ...
  // ========== ANALYTICS - Tabelle crescita avanzate ==========
  {
    ...
    relationships: [
      { type: 'one-to-many', targetTable: 'basket_growth_profiles', foreignKey: 'analysisRunId', description: 'Run genera profili per cestelli' }
    ],
    keyMetrics: [
...

  {
    ...
    relationships: [
      ...
      { type: 'many-to-one', targetTable: 'growth_analysis_runs', foreignKey: 'analysisRunId', description: 'Generato da run analisi' }
    ],
    keyMetrics: [
  ...
  // ========== SCREENING - Tabelle dettaglio ==========
  {
    ...
    relationships: [
      { type: 'many-to-one', targetTable: 'screening_operations', foreignKey: 'screeningId', description: 'Cestello in vagliatura' },
  ...
  {
    name: 'screening_destination_baskets',
    ...
    relationships: [
      { type: 'many-to-one', targetTable: 'screening_operations', foreignKey: 'screeningId', description: 'Cestello da vagliatura' },
  ...
  {
    name: 'screening_impact_analysis',
  ...
  {
    name: 'selection_destination_baskets',
  ...
  {
    name: 'selection_task_assignments',
    ...
    relationships: [
      { type: 'many-to-one', targetTable: 'selection_tasks', foreignKey: 'taskId', description: 'Assegnazione a task' },
...

  {
    ...
    relationships: [
      { type: 'many-to-one', targetTable: 'selection_tasks', foreignKey: 'taskId', description: 'Cestello in task' }
    ],
    keyMetrics: []
  },

  {
    name: 'bag_allocations',
  ...
  // ========== SALES - Tabelle vendite ==========
  {
    ...
    relationships: [
      { type: 'many-to-one', targetTable: 'advanced_sales', foreignKey: 'advancedSaleId', description: 'Sacco in vendita' }
    ],
    keyMetrics: [
      'Sacchi per vendita',
      'Peso medio sacchi',
...

  {
    ...
    relationships: [
      { type: 'many-to-one', targetTable: 'advanced_sales', foreignKey: 'advancedSaleId', description: 'Operazione di vendita' }
    ],
    keyMetrics: []
  },
  ...
  {
    name: 'lot_inventory_transactions',
  ...
  {
    name: 'external_delivery_details_sync',
