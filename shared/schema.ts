...
export const userMenuPreferences = pgTable("user_menu_preferences", {
  ...
  hiddenMenuItems: text("hidden_menu_items").array().notNull().default([]),
...
export const ddt = pgTable("ddt", {
  ...
  clientePec: text("cliente_pec"),
  clienteTelefono: text("cliente_telefono"),
  clienteCodiceDestinatario: text("cliente_codice_destinatario"),
  clienteFattureInCloudId: integer("cliente_fatture_in_cloud_id"),
  oggetto: text("oggetto"),
  causaleTrasporto: text("causale_trasporto").default("Vendita"),
...
export const salesPriceList = pgTable("sales_price_list", {
  ...
  pricePerAnimal: real("price_per_animal").notNull(),
  notes: text("notes"),
  updatedAt: timestamp("updated_at").notNull().defaultNow(),
});
